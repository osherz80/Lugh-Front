    ...
    return (
      ...
      >
        ...
        <AriaInput
          ...
          className="w-full px-4 py-3.5 bg-canvas font-sans border-none rounded-xl outline-none transition-all duration-300 focus:bg-white focus:shadow-[0_0_0_0.2rem_rgba(3,143,123,0.2)] text-zinc-900 placeholder:text-zinc-400 disabled:opacity-50"
          {...rest}
        />
