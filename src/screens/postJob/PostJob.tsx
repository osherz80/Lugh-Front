                ...
                <div className="flex items-center gap-8 h-full">
                    ...
                    <nav className="flex items-center gap-6 h-full">
                        <button
                            ...
                            className={`flex items-center border-b-2 text-sm font-bold transition-all ${formMode === "Manual"
                        ...
                        <button
                            ...
                            className={`flex items-center border-b-2 text-sm font-bold transition-all ${formMode === "Auto"
                                    ? "border-brand text-brand"
                                    : "border-transparent text-zinc-500 hover:text-zinc-800"
                                }`}
                        >
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {employmentOptions.map((option) => (
                                        <button
                                            ...
                                            className={`px-5 py-2.5 rounded-xl font-medium text-sm transition-all shadow-sm active:scale-95 ${employmentType === option
                                                ? "bg-brand text-white"
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {workModelOptions.map((option) => (
                                        <button
                                            ...
                                            className={`px-5 py-2.5 rounded-xl font-medium text-sm transition-all shadow-sm active:scale-95 ${workModel === option
                                                ? "bg-brand text-white"
                                                : "bg-white border border-zinc-300/80 text-zinc-600 hover:border-brand hover:text-brand"
                                                }`}
                                        >
